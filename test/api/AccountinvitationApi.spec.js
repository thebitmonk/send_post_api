  ...
  describe('AccountInvitationApi', function() {
    describe('invitationRouterCreate', function() {
      it('should call invitationRouterCreate successfully', function(done) {
        //uncomment below and update the code to test invitationRouterCreate
        //instance.invitationRouterCreate(function(error) {
    ...
    describe('invitationRouterDelete', function() {
      it('should call invitationRouterDelete successfully', function(done) {
        //uncomment below and update the code to test invitationRouterDelete
        //instance.invitationRouterDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('invitationRouterGetAll', function() {
      it('should call invitationRouterGetAll successfully', function(done) {
        //uncomment below and update the code to test invitationRouterGetAll
        //instance.invitationRouterGetAll(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
