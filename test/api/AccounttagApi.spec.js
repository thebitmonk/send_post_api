  ...
  describe('AccountTagApi', function() {
    describe('tagRouterCreate', function() {
      it('should call tagRouterCreate successfully', function(done) {
        //uncomment below and update the code to test tagRouterCreate
        //instance.tagRouterCreate(function(error) {
    ...
    describe('tagRouterDelete', function() {
      it('should call tagRouterDelete successfully', function(done) {
        //uncomment below and update the code to test tagRouterDelete
        //instance.tagRouterDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('tagRouterGetAll', function() {
      it('should call tagRouterGetAll successfully', function(done) {
        //uncomment below and update the code to test tagRouterGetAll
        //instance.tagRouterGetAll(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
