  ...
  describe('AccountIpStatApi', function() {
    describe('iPStatRouterGetAllAggregateIPStats', function() {
      it('should call iPStatRouterGetAllAggregateIPStats successfully', function(done) {
        //uncomment below and update the code to test iPStatRouterGetAllAggregateIPStats
        //instance.iPStatRouterGetAllAggregateIPStats(function(error) {
    ...
    describe('iPStatRouterGetAllAggregatedProviderStatsForAIP', function() {
      it('should call iPStatRouterGetAllAggregatedProviderStatsForAIP successfully', function(done) {
        //uncomment below and update the code to test iPStatRouterGetAllAggregatedProviderStatsForAIP
        //instance.iPStatRouterGetAllAggregatedProviderStatsForAIP(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('iPStatRouterGetAllAggregatedSubAccountStatsForAnIP', function() {
      it('should call iPStatRouterGetAllAggregatedSubAccountStatsForAnIP successfully', function(done) {
        //uncomment below and update the code to test iPStatRouterGetAllAggregatedSubAccountStatsForAnIP
        //instance.iPStatRouterGetAllAggregatedSubAccountStatsForAnIP(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('iPStatRouterGetAllIPStats', function() {
      it('should call iPStatRouterGetAllIPStats successfully', function(done) {
        //uncomment below and update the code to test iPStatRouterGetAllIPStats
        //instance.iPStatRouterGetAllIPStats(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
