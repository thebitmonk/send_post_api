  ...
  describe('AccountOnboardingApi', function() {
    describe('onboardingRouterCreateUnlockTicket', function() {
      it('should call onboardingRouterCreateUnlockTicket successfully', function(done) {
        //uncomment below and update the code to test onboardingRouterCreateUnlockTicket
        //instance.onboardingRouterCreateUnlockTicket(function(error) {
    ...
    describe('onboardingRouterGetOnboardingChecklist', function() {
      it('should call onboardingRouterGetOnboardingChecklist successfully', function(done) {
        //uncomment below and update the code to test onboardingRouterGetOnboardingChecklist
        //instance.onboardingRouterGetOnboardingChecklist(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('onboardingRouterSendOnboardingWelcomeEmail', function() {
      it('should call onboardingRouterSendOnboardingWelcomeEmail successfully', function(done) {
        //uncomment below and update the code to test onboardingRouterSendOnboardingWelcomeEmail
        //instance.onboardingRouterSendOnboardingWelcomeEmail(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
