  ...
  describe('AccountDomainApi', function() {
    describe('accountDomainRouterCount', function() {
      it('should call accountDomainRouterCount successfully', function(done) {
        //uncomment below and update the code to test accountDomainRouterCount
        //instance.accountDomainRouterCount(function(error) {
    ...
    describe('accountDomainRouterGet', function() {
      it('should call accountDomainRouterGet successfully', function(done) {
        //uncomment below and update the code to test accountDomainRouterGet
        //instance.accountDomainRouterGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('accountDomainRouterGetAll', function() {
      it('should call accountDomainRouterGetAll successfully', function(done) {
        //uncomment below and update the code to test accountDomainRouterGetAll
        //instance.accountDomainRouterGetAll(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
