  ...
  describe('AccountAlertApi', function() {
    describe('alertRouterCount', function() {
      it('should call alertRouterCount successfully', function(done) {
        //uncomment below and update the code to test alertRouterCount
        //instance.alertRouterCount(function(error) {
    ...
    describe('alertRouterCreateAlert', function() {
      it('should call alertRouterCreateAlert successfully', function(done) {
        //uncomment below and update the code to test alertRouterCreateAlert
        //instance.alertRouterCreateAlert(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('alertRouterDelete', function() {
      it('should call alertRouterDelete successfully', function(done) {
        //uncomment below and update the code to test alertRouterDelete
        //instance.alertRouterDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('alertRouterGetAll', function() {
      it('should call alertRouterGetAll successfully', function(done) {
        //uncomment below and update the code to test alertRouterGetAll
        //instance.alertRouterGetAll(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('alertRouterUpdate', function() {
      it('should call alertRouterUpdate successfully', function(done) {
        //uncomment below and update the code to test alertRouterUpdate
        //instance.alertRouterUpdate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
