  ...
  describe('AccountMessageApi', function() {
    describe('messageRouterGet', function() {
      it('should call messageRouterGet successfully', function(done) {
        //uncomment below and update the code to test messageRouterGet
        //instance.messageRouterGet(function(error) {
    ...
    describe('messageRouterGetAllEventsForAMessageId', function() {
      it('should call messageRouterGetAllEventsForAMessageId successfully', function(done) {
        //uncomment below and update the code to test messageRouterGetAllEventsForAMessageId
        //instance.messageRouterGetAllEventsForAMessageId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('messageRouterGetAllEventsForAMessageIdFromANode', function() {
      it('should call messageRouterGetAllEventsForAMessageIdFromANode successfully', function(done) {
        //uncomment below and update the code to test messageRouterGetAllEventsForAMessageIdFromANode
        //instance.messageRouterGetAllEventsForAMessageIdFromANode(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('messageRouterGetMessageFromNode', function() {
      it('should call messageRouterGetMessageFromNode successfully', function(done) {
        //uncomment below and update the code to test messageRouterGetMessageFromNode
        //instance.messageRouterGetMessageFromNode(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
