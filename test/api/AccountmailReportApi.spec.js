  ...
  describe('AccountMailReportApi', function() {
    describe('mailReportRouterMailReport', function() {
      it('should call mailReportRouterMailReport successfully', function(done) {
        //uncomment below and update the code to test mailReportRouterMailReport
        //instance.mailReportRouterMailReport(function(error) {
    ...
    describe('mailReportRouterMailReportGetSingleReport', function() {
      it('should call mailReportRouterMailReportGetSingleReport successfully', function(done) {
        //uncomment below and update the code to test mailReportRouterMailReportGetSingleReport
        //instance.mailReportRouterMailReportGetSingleReport(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('mailReportRouterMailReportProviders', function() {
      it('should call mailReportRouterMailReportProviders successfully', function(done) {
        //uncomment below and update the code to test mailReportRouterMailReportProviders
        //instance.mailReportRouterMailReportProviders(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
