...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AccountsubaccountApi', function() {
      ...
      describe('subAccountRouterCreate', function() {
        it('should call subAccountRouterCreate successfully', function(done) {
          ...
          instance.subAccountRouterCreate(xAccountApiKey, body, function(error, data, response) {
            ...
            expect(data.isPlus).to.be.a('boolean');
            expect(data.isPlus).to.be(false);
            {
      ...
      describe('subAccountRouterMarkPlus', function() {
        it('should call subAccountRouterMarkPlus successfully', function(done) {
          // TODO: uncomment, update parameter values for subAccountRouterMarkPlus call and complete the assertions
          /*
          var xAccountApiKey = "xAccountApiKey_example";
          var subAccountKey = 789;

          instance.subAccountRouterMarkPlus(xAccountApiKey, subAccountKey, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
