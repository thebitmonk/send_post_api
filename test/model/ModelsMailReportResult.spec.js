...
(function(root, factory) {
  ...
  describe('ModelsMailReportResult', function() {
    it('should create an instance of ModelsMailReportResult', function() {
      // uncomment below and update the code to test ModelsMailReportResult
      //var instance = new SendPostApi.ModelsMailReportResult();
    ...
    it('should have the property seedList (base name: "seedList")', function() {
      // uncomment below and update the code to test the property seedList
      //var instance = new SendPostApi.ModelsMailReportResult();
      //expect(instance).to.be();
    });
