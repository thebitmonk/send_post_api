...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsSingleValidatedEmail', function() {
      beforeEach(function() {
        instance = new SendPostApi.ModelsSingleValidatedEmail();
      });

      it('should create an instance of ModelsSingleValidatedEmail', function() {
        // TODO: update the code to test ModelsSingleValidatedEmail
        expect(instance).to.be.a(SendPostApi.ModelsSingleValidatedEmail);
      });
