...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsWebhook', function() {
      beforeEach(function() {
        instance = new SendPostApi.ModelsWebhook();
      });

      it('should create an instance of ModelsWebhook', function() {
        // TODO: update the code to test ModelsWebhook
        expect(instance).to.be.a(SendPostApi.ModelsWebhook);
      });
