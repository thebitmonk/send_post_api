...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPostApi.ModelsAccountWebhook();
  });
  ...
  describe('ModelsAccountWebhook', function() {
    it('should create an instance of ModelsAccountWebhook', function() {
      // uncomment below and update the code to test ModelsAccountWebhook
      //var instance = new SendPostApi.ModelsAccountWebhook();
      //expect(instance).to.be.a(SendPostApi.ModelsAccountWebhook);
    });
