...
(function(root, factory) {
  ...
  describe('ModelsThirdPartySendingProvider', function() {
    it('should create an instance of ModelsThirdPartySendingProvider', function() {
      // uncomment below and update the code to test ModelsThirdPartySendingProvider
      //var instance = new SendPostApi.ModelsThirdPartySendingProvider();
    ...
    it('should have the property ratePerHour (base name: "ratePerHour")', function() {
      // uncomment below and update the code to test the property ratePerHour
      //var instance = new SendPostApi.ModelsThirdPartySendingProvider();
      //expect(instance).to.be();
    });
