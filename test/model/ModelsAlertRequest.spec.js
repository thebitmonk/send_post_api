...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsAlertRequest', function() {
      ...
      it('should have the property notificatonType (base name: "notificatonType")', function() {
        // TODO: update the code to test the property notificatonType
        expect(instance).to.have.property('notificatonType');
        // expect(instance.notificatonType).to.be(expectedValueLiteral);
      });
