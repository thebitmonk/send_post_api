...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsHubspotTicket', function() {
      beforeEach(function() {
        instance = new SendPostApi.ModelsHubspotTicket();
      });

      it('should create an instance of ModelsHubspotTicket', function() {
        // TODO: update the code to test ModelsHubspotTicket
        expect(instance).to.be.a(SendPostApi.ModelsHubspotTicket);
      });
