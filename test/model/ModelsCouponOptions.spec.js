...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPostApi.ModelsCouponOptions();
  });
  ...
  describe('ModelsCouponOptions', function() {
    it('should create an instance of ModelsCouponOptions', function() {
      // uncomment below and update the code to test ModelsCouponOptions
      //var instance = new SendPostApi.ModelsCouponOptions();
      //expect(instance).to.be.a(SendPostApi.ModelsCouponOptions);
    });
