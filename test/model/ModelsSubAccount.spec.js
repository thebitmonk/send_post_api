...
(function(root, factory) {
  ...
  describe('ModelsSubAccount', function() {
    it('should create an instance of ModelsSubAccount', function() {
      // uncomment below and update the code to test ModelsSubAccount
      //var instance = new SendPostApi.ModelsSubAccount();
    ...
    it('should have the property smtpAuths (base name: "smtpAuths")', function() {
      // uncomment below and update the code to test the property smtpAuths
      //var instance = new SendPostApi.ModelsSubAccount();
      //expect(instance).to.be();
    });
