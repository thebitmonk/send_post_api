...
(function(root, factory) {
  ...
  describe('ModelsTaxDetails', function() {
    it('should create an instance of ModelsTaxDetails', function() {
      // uncomment below and update the code to test ModelsTaxDetails
      //var instance = new SendPostApi.ModelsTaxDetails();
    ...
    it('should have the property percentageDecimal (base name: "percentage_decimal")', function() {
      // uncomment below and update the code to test the property percentageDecimal
      //var instance = new SendPostApi.ModelsTaxDetails();
      //expect(instance).to.be();
    });
