...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ApiBillingPortalSession', function() {
      beforeEach(function() {
        instance = new SendPostApi.ApiBillingPortalSession();
      });

      it('should create an instance of ApiBillingPortalSession', function() {
        // TODO: update the code to test ApiBillingPortalSession
        expect(instance).to.be.a(SendPostApi.ApiBillingPortalSession);
      });
