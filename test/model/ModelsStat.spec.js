...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPostApi.ModelsStat();
  });
  ...
  describe('ModelsStat', function() {
    it('should create an instance of ModelsStat', function() {
      // uncomment below and update the code to test ModelsStat
      //var instance = new SendPostApi.ModelsStat();
      //expect(instance).to.be.a(SendPostApi.ModelsStat);
    });
