...
(function(root, factory) {
  ...
  describe('ModelsCertificateIssuer', function() {
    it('should create an instance of ModelsCertificateIssuer', function() {
      // uncomment below and update the code to test ModelsCertificateIssuer
      //var instance = new SendPostApi.ModelsCertificateIssuer();
    ...
    it('should have the property organizationUnit (base name: "organizationUnit")', function() {
      // uncomment below and update the code to test the property organizationUnit
      //var instance = new SendPostApi.ModelsCertificateIssuer();
      //expect(instance).to.be();
    });
