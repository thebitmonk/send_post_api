...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsETag', function() {
      beforeEach(function() {
        instance = new SendPostApi.ModelsETag();
      });

      it('should create an instance of ModelsETag', function() {
        // TODO: update the code to test ModelsETag
        expect(instance).to.be.a(SendPostApi.ModelsETag);
      });
