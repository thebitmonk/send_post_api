...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsEAccountTemplate', function() {
      beforeEach(function() {
        instance = new SendPostApi.ModelsEAccountTemplate();
      });

      it('should create an instance of ModelsEAccountTemplate', function() {
        // TODO: update the code to test ModelsEAccountTemplate
        expect(instance).to.be.a(SendPostApi.ModelsEAccountTemplate);
      });
