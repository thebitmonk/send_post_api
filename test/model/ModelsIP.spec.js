...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsIP', function() {
      ...
      it('should have the property autoWarmupPlan (base name: "autoWarmupPlan")', function() {
        // TODO: update the code to test the property autoWarmupPlan
        expect(instance).to.have.property('autoWarmupPlan');
        // expect(instance.autoWarmupPlan).to.be(expectedValueLiteral);
      });
