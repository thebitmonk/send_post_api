...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SendPostApi.ModelsASStat();
  });
  ...
  describe('ModelsASStat', function() {
    it('should create an instance of ModelsASStat', function() {
      // uncomment below and update the code to test ModelsASStat
      //var instance = new SendPostApi.ModelsASStat();
      //expect(instance).to.be.a(SendPostApi.ModelsASStat);
    });
