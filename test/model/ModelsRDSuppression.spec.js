...
(function(root, factory) {
  ...
  describe('ModelsRDSuppression', function() {
    it('should create an instance of ModelsRDSuppression', function() {
      // uncomment below and update the code to test ModelsRDSuppression
      //var instance = new SendPostApi.ModelsRDSuppression();
    ...
    it('should have the property suppressions (base name: "suppressions")', function() {
      // uncomment below and update the code to test the property suppressions
      //var instance = new SendPostApi.ModelsRDSuppression();
