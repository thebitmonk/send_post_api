...
class ModelsClusterCache {
    ...
    constructor() { 
        ...
        ModelsClusterCache.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ModelsClusterCache</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ModelsClusterCache</code>.
     */
...
export default ModelsClusterCache;
