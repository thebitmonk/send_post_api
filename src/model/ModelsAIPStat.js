...
class ModelsAIPStat {
    ...
    /**
     * Validates the JSON data with respect to <code>ModelsAIPStat</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ModelsAIPStat</code>.
     */
 ...
 */
ModelsAIPStat.prototype['clicked'] = undefined;

/**
 * @member {Number} delivered
 */
ModelsAIPStat.prototype['delivered'] = undefined;

/**
 * @member {Number} dropped
 */
ModelsAIPStat.prototype['dropped'] = undefined;

/**
 * @member {Number} hardBounced
 */
ModelsAIPStat.prototype['hardBounced'] = undefined;
 ...
 */
ModelsAIPStat.prototype['opened'] = undefined;

/**
 * @member {Number} processed
 */
ModelsAIPStat.prototype['processed'] = undefined;
 ...
 * @member {Number} sent
 */
ModelsAIPStat.prototype['sent'] = undefined;

/**
 * @member {Number} softBounced
 */
ModelsAIPStat.prototype['softBounced'] = undefined;

/**
 * @member {Number} spam
 */
ModelsAIPStat.prototype['spam'] = undefined;

/**
 * @member {Number} unsubscribed
 */
ModelsAIPStat.prototype['unsubscribed'] = undefined;
