...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ModelsValidationStatus'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ModelsValidationStatus'));
  } else {
    // Browser globals (root is window)
    if (!root.SendPostApi) {
      root.SendPostApi = {};
    }
    root.SendPostApi.ModelsValidation = factory(root.SendPostApi.ApiClient, root.SendPostApi.ModelsValidationStatus);
  }
}(this, function(ApiClient, ModelsValidationStatus) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('reason'))
        obj.reason = ModelsValidationStatus.constructFromObject(data['reason']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/ModelsValidationStatus} reason
   */
