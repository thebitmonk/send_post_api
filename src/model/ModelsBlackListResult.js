...
class ModelsBlackListResult {
    ...
    constructor() { 
        ...
        ModelsBlackListResult.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ModelsBlackListResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ModelsBlackListResult</code>.
     */
    static validateJSON(data) {
        if (data['blackLists']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['blackLists'])) {
                throw new Error("Expected the field `blackLists` to be an array in the JSON data but got " + data['blackLists']);
            }
            // validate the optional field `blackLists` (array)
            for (const item of data['blackLists']) {
                ModelsBlackListEngine.validateJSON(item);
            };
        }
...
export default ModelsBlackListResult;
