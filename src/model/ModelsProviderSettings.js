...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ModelsBackOffConfiguration', 'model/ModelsBackOffTrigger', 'model/ModelsWarmupDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ModelsBackOffConfiguration'), require('./ModelsBackOffTrigger'), require('./ModelsWarmupDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.SendPostApi) {
      root.SendPostApi = {};
    }
    root.SendPostApi.ModelsProviderSettings = factory(root.SendPostApi.ApiClient, root.SendPostApi.ModelsBackOffConfiguration, root.SendPostApi.ModelsBackOffTrigger, root.SendPostApi.ModelsWarmupDetails);
  }
}(this, function(ApiClient, ModelsBackOffConfiguration, ModelsBackOffTrigger, ModelsWarmupDetails) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('warmupSettings'))
        obj.warmupSettings = ModelsWarmupDetails.constructFromObject(data['warmupSettings']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/ModelsWarmupDetails} warmupSettings
   */
  exports.prototype.warmupSettings = undefined;
