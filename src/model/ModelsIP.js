...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ModelsAutoWarmupPlan', 'model/ModelsIPState', 'model/ModelsIPType', 'model/ModelsLabel', 'model/ModelsSystemDomain'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ModelsAutoWarmupPlan'), require('./ModelsIPState'), require('./ModelsIPType'), require('./ModelsLabel'), require('./ModelsSystemDomain'));
  } else {
    // Browser globals (root is window)
    if (!root.SendPostApi) {
      root.SendPostApi = {};
    }
    root.SendPostApi.ModelsIP = factory(root.SendPostApi.ApiClient, root.SendPostApi.ModelsAutoWarmupPlan, root.SendPostApi.ModelsIPState, root.SendPostApi.ModelsIPType, root.SendPostApi.ModelsLabel, root.SendPostApi.ModelsSystemDomain);
  }
}(this, function(ApiClient, ModelsAutoWarmupPlan, ModelsIPState, ModelsIPType, ModelsLabel, ModelsSystemDomain) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('autoWarmupPlan'))
        obj.autoWarmupPlan = ModelsAutoWarmupPlan.constructFromObject(data['autoWarmupPlan']);
      ...
      if (data.hasOwnProperty('state'))
        obj.state = ModelsIPState.constructFromObject(data['state']);
  ...
  /**
   * @member {module:model/ModelsAutoWarmupPlan} autoWarmupPlan
   */
  exports.prototype.autoWarmupPlan = undefined;
  ...
  /**
   * @member {module:model/ModelsIPState} state
   */
