...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ModelsAlertLabel', 'model/ModelsPriority'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ModelsAlertLabel'), require('./ModelsPriority'));
  } else {
    // Browser globals (root is window)
    if (!root.SendPostApi) {
      root.SendPostApi = {};
    }
    root.SendPostApi.ModelsAlert = factory(root.SendPostApi.ApiClient, root.SendPostApi.ModelsAlertLabel, root.SendPostApi.ModelsPriority);
  }
}(this, function(ApiClient, ModelsAlertLabel, ModelsPriority) {
  'use strict';
