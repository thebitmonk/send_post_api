 ...
 * @version 1.0.0
 */
class ModelsIPDomainWarmupStatus {
    /**
    ...
    constructor() { 
        ...
        ModelsIPDomainWarmupStatus.initialize(this);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ModelsIPDomainWarmupStatus</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ModelsIPDomainWarmupStatus</code>.
     */
...
export default ModelsIPDomainWarmupStatus;
