...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendPostApi.ModelsListCleaningJob = factory(root.SendPostApi.ApiClient, root.SendPostApi.ModelsJobStatus);
  }
}(this, function(ApiClient, ModelsJobStatus) {
  'use strict';

  /**
   * The ModelsListCleaningJob model module.
   * @module model/ModelsListCleaningJob
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ModelsListCleaningJob</code>.
   * @alias module:model/ModelsListCleaningJob
   * @class
   */
  ...
  /**
   * Constructs a <code>ModelsListCleaningJob</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ModelsListCleaningJob} obj Optional instance to populate.
   * @return {module:model/ModelsListCleaningJob} The populated <code>ModelsListCleaningJob</code> instance.
   */
   ...
   */
  exports.prototype.currentBatch = undefined;
