...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ModelsEIPPool', 'model/ModelsIPPool'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ModelsEIPPool'), require('../model/ModelsIPPool'));
  } else {
    // Browser globals (root is window)
    if (!root.SendPostApi) {
      root.SendPostApi = {};
    }
    root.SendPostApi.SubaccountippoolApi = factory(root.SendPostApi.ApiClient, root.SendPostApi.ModelsEIPPool, root.SendPostApi.ModelsIPPool);
  }
}(this, function(ApiClient, ModelsEIPPool, ModelsIPPool) {
  'use strict';
