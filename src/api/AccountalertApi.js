...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ModelsAlert', 'model/ModelsAlertRequest', 'model/ModelsCountStat', 'model/ModelsDetailedAlert'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ModelsAlert'), require('../model/ModelsAlertRequest'), require('../model/ModelsCountStat'), require('../model/ModelsDetailedAlert'));
  } else {
    // Browser globals (root is window)
    if (!root.SendPostApi) {
      root.SendPostApi = {};
    }
    root.SendPostApi.AccountalertApi = factory(root.SendPostApi.ApiClient, root.SendPostApi.ModelsAlert, root.SendPostApi.ModelsAlertRequest, root.SendPostApi.ModelsCountStat, root.SendPostApi.ModelsDetailedAlert);
  }
}(this, function(ApiClient, ModelsAlert, ModelsAlertRequest, ModelsCountStat, ModelsDetailedAlert) {
  'use strict';
