...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the subAccountRouterMarkPlus operation.
     * @callback module:api/AccountsubaccountApi~subAccountRouterMarkPlusCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ModelsSubAccount} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} xAccountApiKey Account API Key
     * @param {Number} subAccountKey The SubAccountId you want to Mark Plus
     * @param {module:api/AccountsubaccountApi~subAccountRouterMarkPlusCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ModelsSubAccount}
     */
    this.subAccountRouterMarkPlus = function(xAccountApiKey, subAccountKey, callback) {
      var postBody = null;

      // verify the required parameter 'xAccountApiKey' is set
      if (xAccountApiKey === undefined || xAccountApiKey === null) {
        throw new Error("Missing the required parameter 'xAccountApiKey' when calling subAccountRouterMarkPlus");
      }

      // verify the required parameter 'subAccountKey' is set
      if (subAccountKey === undefined || subAccountKey === null) {
        throw new Error("Missing the required parameter 'subAccountKey' when calling subAccountRouterMarkPlus");
      }
      ...
      return this.apiClient.callApi(
        '/account/subaccount/{subAccountKey}/plus', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
