...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} messageId The UUID of message which was sent
     * @param {String} emailType The type of email such as gmail, yahoo etc. which was sent. This is inferred from to email address
     * @param {String} email email to add in suppression
     ...
     */
    this.trackRouterTrackUnsubscribe = function(ipId, accountId, subAccountId, messageId, emailType, email, callback) {
      var postBody = null;
      ...
      if (email === undefined || email === null) {
        throw new Error("Missing the required parameter 'email' when calling trackRouterTrackUnsubscribe");
      }
