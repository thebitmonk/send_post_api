...
* @version 1.0.0
*/
export class SubaccountemailApi {
    ...
    */
     ...
     * @callback moduleapi/SubaccountemailApi~emailRouterSendEmailCallback
     ...
     */
    emailRouterSendEmail(body, xSubAccountApiKey, opts, callback) {
      opts = opts || {};
      let postBody = body;
      ...
      let headerParams = {
        'X-SubAccount-ApiKey': xSubAccountApiKey,'X-SendPost-Mock-Email': opts['xSendPostMockEmail'],'X-SendPost-Mock-Time-Shift': opts['xSendPostMockTimeShift']
      };
      let formParams = {
     ...
     * @callback moduleapi/SubaccountemailApi~emailRouterSendEmailWithTemplateCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/ModelsEmailResponse>{ data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    emailRouterSendEmailWithTemplate(body, xSubAccountApiKey, callback) {
