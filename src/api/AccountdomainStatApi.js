...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Number} domainName the domainName you want to get
     ...
     */
    this.domainStatRouterGetAllAggregateDomainStatsByGroup = function(xAccountApiKey, domainName, provider, opts, callback) {
      opts = opts || {};
      var postBody = null;
      ...
      if (domainName === undefined || domainName === null) {
        throw new Error("Missing the required parameter 'domainName' when calling domainStatRouterGetAllAggregateDomainStatsByGroup");
      }
      ...
      return this.apiClient.callApi(
        '/account/domainStat/{domainName}/aggregate/provider', 'GET',
     ...
     * @param {String} xAccountApiKey Account API Key
     * @param {String} domainName the IPId you want to get
     * @param {Object} opts Optional parameters
     * @param {String} opts.from from date
     * @param {String} opts.to to date
     ...
     * data is of type: {@link module:model/ModelsStat}
     */
    this.domainStatRouterGetStatsForASingleDomainStats = function(xAccountApiKey, domainName, opts, callback) {
      opts = opts || {};
      var postBody = null;
      ...
      // verify the required parameter 'domainName' is set
      if (domainName === undefined || domainName === null) {
        throw new Error("Missing the required parameter 'domainName' when calling domainStatRouterGetStatsForASingleDomainStats");
      }
      ...
      return this.apiClient.callApi(
        '/account/domainStat/{domainName}/aggregate', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
