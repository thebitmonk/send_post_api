...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} messageId the messageId that you want to retrieve
     * @param {Number} subAccountId the subAccountId that you want to retrieve
     ...
     */
    this.messageRouterGetAllEventsForAMessageId = function(xAccountApiKey, messageId, subAccountId, callback) {
      var postBody = null;
      ...
      if (subAccountId === undefined || subAccountId === null) {
        throw new Error("Missing the required parameter 'subAccountId' when calling messageRouterGetAllEventsForAMessageId");
      }
