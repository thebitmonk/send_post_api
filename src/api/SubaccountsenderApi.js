...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ModelsESender', 'model/ModelsSender'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ModelsESender'), require('../model/ModelsSender'));
  } else {
    // Browser globals (root is window)
    if (!root.SendPostApi) {
      root.SendPostApi = {};
    }
    root.SendPostApi.SubaccountsenderApi = factory(root.SendPostApi.ApiClient, root.SendPostApi.ModelsESender, root.SendPostApi.ModelsSender);
  }
}(this, function(ApiClient, ModelsESender, ModelsSender) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     */
    this.senderRouterGetAll = function(xSubAccountApiKey, callback) {
      var postBody = null;
