...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ModelsCountStat', 'model/ModelsDeleteResponse', 'model/ModelsIIP', 'model/ModelsIP', 'model/ModelsIPHealthResponse', 'model/ModelsIncident'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ModelsCountStat'), require('../model/ModelsDeleteResponse'), require('../model/ModelsIIP'), require('../model/ModelsIP'), require('../model/ModelsIPHealthResponse'), require('../model/ModelsIncident'));
  } else {
    // Browser globals (root is window)
    if (!root.SendPostApi) {
      root.SendPostApi = {};
    }
    root.SendPostApi.AccountipApi = factory(root.SendPostApi.ApiClient, root.SendPostApi.ModelsCountStat, root.SendPostApi.ModelsDeleteResponse, root.SendPostApi.ModelsIIP, root.SendPostApi.ModelsIP, root.SendPostApi.ModelsIPHealthResponse, root.SendPostApi.ModelsIncident);
  }
}(this, function(ApiClient, ModelsCountStat, ModelsDeleteResponse, ModelsIIP, ModelsIP, ModelsIPHealthResponse, ModelsIncident) {
  'use strict';
