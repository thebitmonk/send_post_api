...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ModelsAGDomainStat', 'model/ModelsAGIPStat', 'model/ModelsAGSubAccountStat', 'model/ModelsAGTPSPStat', 'model/ModelsAccountCycleUsage', 'model/ModelsCountStat', 'model/ModelsRStat', 'model/ModelsStat', 'model/ModelsValidationStat'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ModelsAGDomainStat'), require('../model/ModelsAGIPStat'), require('../model/ModelsAGSubAccountStat'), require('../model/ModelsAGTPSPStat'), require('../model/ModelsAccountCycleUsage'), require('../model/ModelsCountStat'), require('../model/ModelsRStat'), require('../model/ModelsStat'), require('../model/ModelsValidationStat'));
  } else {
    // Browser globals (root is window)
    if (!root.SendPostApi) {
      root.SendPostApi = {};
    }
    root.SendPostApi.AccountstatApi = factory(root.SendPostApi.ApiClient, root.SendPostApi.ModelsAGDomainStat, root.SendPostApi.ModelsAGIPStat, root.SendPostApi.ModelsAGSubAccountStat, root.SendPostApi.ModelsAGTPSPStat, root.SendPostApi.ModelsAccountCycleUsage, root.SendPostApi.ModelsCountStat, root.SendPostApi.ModelsRStat, root.SendPostApi.ModelsStat, root.SendPostApi.ModelsValidationStat);
  }
}(this, function(ApiClient, ModelsAGDomainStat, ModelsAGIPStat, ModelsAGSubAccountStat, ModelsAGTPSPStat, ModelsAccountCycleUsage, ModelsCountStat, ModelsRStat, ModelsStat, ModelsValidationStat) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/ModelsValidationStat} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/ModelsValidationStat}
     */
    this.accountStatRouterGetAllAggregateAccountValidationStats = function(xAccountApiKey, opts, callback) {
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = ModelsValidationStat;
