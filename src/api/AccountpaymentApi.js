...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ModelsBillingPortalSession', 'model/ModelsCountry', 'model/ModelsCouponOptions', 'model/ModelsPaymentAddress', 'model/ModelsPaymentOptions', 'model/ModelsPaymentStatus', 'model/ModelsPricing', 'model/ModelsTaxDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ModelsBillingPortalSession'), require('../model/ModelsCountry'), require('../model/ModelsCouponOptions'), require('../model/ModelsPaymentAddress'), require('../model/ModelsPaymentOptions'), require('../model/ModelsPaymentStatus'), require('../model/ModelsPricing'), require('../model/ModelsTaxDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.SendPostApi) {
      root.SendPostApi = {};
    }
    root.SendPostApi.AccountpaymentApi = factory(root.SendPostApi.ApiClient, root.SendPostApi.ModelsBillingPortalSession, root.SendPostApi.ModelsCountry, root.SendPostApi.ModelsCouponOptions, root.SendPostApi.ModelsPaymentAddress, root.SendPostApi.ModelsPaymentOptions, root.SendPostApi.ModelsPaymentStatus, root.SendPostApi.ModelsPricing, root.SendPostApi.ModelsTaxDetails);
  }
}(this, function(ApiClient, ModelsBillingPortalSession, ModelsCountry, ModelsCouponOptions, ModelsPaymentAddress, ModelsPaymentOptions, ModelsPaymentStatus, ModelsPricing, ModelsTaxDetails) {
  'use strict';
