...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EUpdateTPSP', 'model/ModelsCountStat', 'model/ModelsDeleteResponse', 'model/ModelsEMember', 'model/ModelsEThirdPartySendingProvider', 'model/ModelsThirdPartySendingProvider'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/EUpdateTPSP'), require('../model/ModelsCountStat'), require('../model/ModelsDeleteResponse'), require('../model/ModelsEMember'), require('../model/ModelsEThirdPartySendingProvider'), require('../model/ModelsThirdPartySendingProvider'));
  } else {
    // Browser globals (root is window)
    if (!root.SendPostApi) {
      root.SendPostApi = {};
    }
    root.SendPostApi.AccounttpspApi = factory(root.SendPostApi.ApiClient, root.SendPostApi.EUpdateTPSP, root.SendPostApi.ModelsCountStat, root.SendPostApi.ModelsDeleteResponse, root.SendPostApi.ModelsEMember, root.SendPostApi.ModelsEThirdPartySendingProvider, root.SendPostApi.ModelsThirdPartySendingProvider);
  }
}(this, function(ApiClient, EUpdateTPSP, ModelsCountStat, ModelsDeleteResponse, ModelsEMember, ModelsEThirdPartySendingProvider, ModelsThirdPartySendingProvider) {
  'use strict';
