...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ModelsAGStat', 'model/ModelsAIPStat', 'model/ModelsAccount', 'model/ModelsAccountIPPool', 'model/ModelsAccountWebhook', 'model/ModelsAlert', 'model/ModelsAlertLabel', 'model/ModelsAlertRequest', 'model/ModelsAuthInfo', 'model/ModelsBackOffConfiguration', 'model/ModelsBackOffDecreaseType', 'model/ModelsBackOffTrigger', 'model/ModelsBlacklistStatus', 'model/ModelsBulkResponse', 'model/ModelsCity', 'model/ModelsCleanedList', 'model/ModelsCountStat', 'model/ModelsDNSRecord', 'model/ModelsDeleteResponse', 'model/ModelsDetailedAlert', 'model/ModelsDomain', 'model/ModelsEAccount', 'model/ModelsEDomain', 'model/ModelsEIP', 'model/ModelsEIPPool', 'model/ModelsEIntegration', 'model/ModelsEInvitation', 'model/ModelsESender', 'model/ModelsESubAccount', 'model/ModelsEValidation', 'model/ModelsEWebhook', 'model/ModelsEmailErrorCode', 'model/ModelsEmailList', 'model/ModelsEmailMessage', 'model/ModelsEmailResponse', 'model/ModelsEventMetadata', 'model/ModelsEventType', 'model/ModelsFrequencyType', 'model/ModelsFrom', 'model/ModelsGlockappsBlacklist', 'model/ModelsGlockappsMonitorStat', 'model/ModelsIIP', 'model/ModelsIP', 'model/ModelsIPPool', 'model/ModelsIPPoolType', 'model/ModelsIPStat', 'model/ModelsIPType', 'model/ModelsInstance', 'model/ModelsIntegration', 'model/ModelsIntegrationSettings', 'model/ModelsIntegrationType', 'model/ModelsInvitation', 'model/ModelsInvitationStatus', 'model/ModelsLabel', 'model/ModelsMember', 'model/ModelsMemberRole', 'model/ModelsNotificationType', 'model/ModelsPIPStat', 'model/ModelsPriority', 'model/ModelsQEmailMessage', 'model/ModelsQEvent', 'model/ModelsRDSuppression', 'model/ModelsRGlockappsMonitorStat', 'model/ModelsRIPStat', 'model/ModelsRStat', 'model/ModelsRSuppression', 'model/ModelsReplyTo', 'model/ModelsResponse', 'model/ModelsSIPStat', 'model/ModelsSMTPStat', 'model/ModelsSender', 'model/ModelsSingleCleanedMail', 'model/ModelsStat', 'model/ModelsSubAccount', 'model/ModelsSubAccountType', 'model/ModelsSuppression', 'model/ModelsSuppressionEmail', 'model/ModelsSuppressionReason', 'model/ModelsSystemDNSRecord', 'model/ModelsSystemDomain', 'model/ModelsTo', 'model/ModelsValidation', 'model/ModelsValidationReason', 'model/ModelsWMessage', 'model/UaparserDevice', 'model/UaparserOs', 'model/UaparserUserAgent', 'api/AccountalertApi', 'api/AccounteventApi', 'api/AccountintegrationApi', 'api/AccountinvitationApi', 'api/AccountipApi', 'api/AccountippoolApi', 'api/AccountipstatApi', 'api/AccountlabelApi', 'api/AccountmemberApi', 'api/AccountmessageApi', 'api/AccountrecipientApi', 'api/AccountsmtpstatApi', 'api/AccountstatApi', 'api/AccountsubaccountApi', 'api/AccountvalidateApi', 'api/AccountvalidationApi', 'api/AccountwebhookApi', 'api/AuthApi', 'api/ClusterApi', 'api/SmtpApi', 'api/SubaccountdomainApi', 'api/SubaccountemailApi', 'api/SubaccountippoolApi', 'api/SubaccountsenderApi', 'api/SubaccountstatApi', 'api/SubaccountsuppressionApi', 'api/TrackApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/ModelsAGStat'), require('./model/ModelsAIPStat'), require('./model/ModelsAccount'), require('./model/ModelsAccountIPPool'), require('./model/ModelsAccountWebhook'), require('./model/ModelsAlert'), require('./model/ModelsAlertLabel'), require('./model/ModelsAlertRequest'), require('./model/ModelsAuthInfo'), require('./model/ModelsBackOffConfiguration'), require('./model/ModelsBackOffDecreaseType'), require('./model/ModelsBackOffTrigger'), require('./model/ModelsBlacklistStatus'), require('./model/ModelsBulkResponse'), require('./model/ModelsCity'), require('./model/ModelsCleanedList'), require('./model/ModelsCountStat'), require('./model/ModelsDNSRecord'), require('./model/ModelsDeleteResponse'), require('./model/ModelsDetailedAlert'), require('./model/ModelsDomain'), require('./model/ModelsEAccount'), require('./model/ModelsEDomain'), require('./model/ModelsEIP'), require('./model/ModelsEIPPool'), require('./model/ModelsEIntegration'), require('./model/ModelsEInvitation'), require('./model/ModelsESender'), require('./model/ModelsESubAccount'), require('./model/ModelsEValidation'), require('./model/ModelsEWebhook'), require('./model/ModelsEmailErrorCode'), require('./model/ModelsEmailList'), require('./model/ModelsEmailMessage'), require('./model/ModelsEmailResponse'), require('./model/ModelsEventMetadata'), require('./model/ModelsEventType'), require('./model/ModelsFrequencyType'), require('./model/ModelsFrom'), require('./model/ModelsGlockappsBlacklist'), require('./model/ModelsGlockappsMonitorStat'), require('./model/ModelsIIP'), require('./model/ModelsIP'), require('./model/ModelsIPPool'), require('./model/ModelsIPPoolType'), require('./model/ModelsIPStat'), require('./model/ModelsIPType'), require('./model/ModelsInstance'), require('./model/ModelsIntegration'), require('./model/ModelsIntegrationSettings'), require('./model/ModelsIntegrationType'), require('./model/ModelsInvitation'), require('./model/ModelsInvitationStatus'), require('./model/ModelsLabel'), require('./model/ModelsMember'), require('./model/ModelsMemberRole'), require('./model/ModelsNotificationType'), require('./model/ModelsPIPStat'), require('./model/ModelsPriority'), require('./model/ModelsQEmailMessage'), require('./model/ModelsQEvent'), require('./model/ModelsRDSuppression'), require('./model/ModelsRGlockappsMonitorStat'), require('./model/ModelsRIPStat'), require('./model/ModelsRStat'), require('./model/ModelsRSuppression'), require('./model/ModelsReplyTo'), require('./model/ModelsResponse'), require('./model/ModelsSIPStat'), require('./model/ModelsSMTPStat'), require('./model/ModelsSender'), require('./model/ModelsSingleCleanedMail'), require('./model/ModelsStat'), require('./model/ModelsSubAccount'), require('./model/ModelsSubAccountType'), require('./model/ModelsSuppression'), require('./model/ModelsSuppressionEmail'), require('./model/ModelsSuppressionReason'), require('./model/ModelsSystemDNSRecord'), require('./model/ModelsSystemDomain'), require('./model/ModelsTo'), require('./model/ModelsValidation'), require('./model/ModelsValidationReason'), require('./model/ModelsWMessage'), require('./model/UaparserDevice'), require('./model/UaparserOs'), require('./model/UaparserUserAgent'), require('./api/AccountalertApi'), require('./api/AccounteventApi'), require('./api/AccountintegrationApi'), require('./api/AccountinvitationApi'), require('./api/AccountipApi'), require('./api/AccountippoolApi'), require('./api/AccountipstatApi'), require('./api/AccountlabelApi'), require('./api/AccountmemberApi'), require('./api/AccountmessageApi'), require('./api/AccountrecipientApi'), require('./api/AccountsmtpstatApi'), require('./api/AccountstatApi'), require('./api/AccountsubaccountApi'), require('./api/AccountvalidateApi'), require('./api/AccountvalidationApi'), require('./api/AccountwebhookApi'), require('./api/AuthApi'), require('./api/ClusterApi'), require('./api/SmtpApi'), require('./api/SubaccountdomainApi'), require('./api/SubaccountemailApi'), require('./api/SubaccountippoolApi'), require('./api/SubaccountsenderApi'), require('./api/SubaccountstatApi'), require('./api/SubaccountsuppressionApi'), require('./api/TrackApi'));
  }
}(function(ApiClient, ModelsAGStat, ModelsAIPStat, ModelsAccount, ModelsAccountIPPool, ModelsAccountWebhook, ModelsAlert, ModelsAlertLabel, ModelsAlertRequest, ModelsAuthInfo, ModelsBackOffConfiguration, ModelsBackOffDecreaseType, ModelsBackOffTrigger, ModelsBlacklistStatus, ModelsBulkResponse, ModelsCity, ModelsCleanedList, ModelsCountStat, ModelsDNSRecord, ModelsDeleteResponse, ModelsDetailedAlert, ModelsDomain, ModelsEAccount, ModelsEDomain, ModelsEIP, ModelsEIPPool, ModelsEIntegration, ModelsEInvitation, ModelsESender, ModelsESubAccount, ModelsEValidation, ModelsEWebhook, ModelsEmailErrorCode, ModelsEmailList, ModelsEmailMessage, ModelsEmailResponse, ModelsEventMetadata, ModelsEventType, ModelsFrequencyType, ModelsFrom, ModelsGlockappsBlacklist, ModelsGlockappsMonitorStat, ModelsIIP, ModelsIP, ModelsIPPool, ModelsIPPoolType, ModelsIPStat, ModelsIPType, ModelsInstance, ModelsIntegration, ModelsIntegrationSettings, ModelsIntegrationType, ModelsInvitation, ModelsInvitationStatus, ModelsLabel, ModelsMember, ModelsMemberRole, ModelsNotificationType, ModelsPIPStat, ModelsPriority, ModelsQEmailMessage, ModelsQEvent, ModelsRDSuppression, ModelsRGlockappsMonitorStat, ModelsRIPStat, ModelsRStat, ModelsRSuppression, ModelsReplyTo, ModelsResponse, ModelsSIPStat, ModelsSMTPStat, ModelsSender, ModelsSingleCleanedMail, ModelsStat, ModelsSubAccount, ModelsSubAccountType, ModelsSuppression, ModelsSuppressionEmail, ModelsSuppressionReason, ModelsSystemDNSRecord, ModelsSystemDomain, ModelsTo, ModelsValidation, ModelsValidationReason, ModelsWMessage, UaparserDevice, UaparserOs, UaparserUserAgent, AccountalertApi, AccounteventApi, AccountintegrationApi, AccountinvitationApi, AccountipApi, AccountippoolApi, AccountipstatApi, AccountlabelApi, AccountmemberApi, AccountmessageApi, AccountrecipientApi, AccountsmtpstatApi, AccountstatApi, AccountsubaccountApi, AccountvalidateApi, AccountvalidationApi, AccountwebhookApi, AuthApi, ClusterApi, SmtpApi, SubaccountdomainApi, SubaccountemailApi, SubaccountippoolApi, SubaccountsenderApi, SubaccountstatApi, SubaccountsuppressionApi, TrackApi) {
  'use strict';
  ...
  var exports = {
    ...
    /**
     * The ModelsPriority model constructor.
     * @property {module:model/ModelsPriority}
     */
    ...
    /**
     * The AccountvalidateApi service constructor.
     * @property {module:api/AccountvalidateApi}
     */
    AccountvalidateApi: AccountvalidateApi,
    /**
