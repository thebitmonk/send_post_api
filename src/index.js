...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Model3668100x140007f5680False', 'model/Model3670910x140007f5770False', 'model/Model8726040x14000e02750False', 'model/ModelExport', 'model/ModelsAGDomainStat', 'model/ModelsAGIPStat', 'model/ModelsAGStat', 'model/ModelsAGSubAccountStat', 'model/ModelsAGTPSPStat', 'model/ModelsAIPStat', 'model/ModelsAPStat', 'model/ModelsASStat', 'model/ModelsAccount', 'model/ModelsAccountCycleUsage', 'model/ModelsAccountDomain', 'model/ModelsAccountIPPool', 'model/ModelsAccountTemplate', 'model/ModelsAccountUnlockTicket', 'model/ModelsAccountWebhook', 'model/ModelsAlert', 'model/ModelsAlertLabel', 'model/ModelsAlertRequest', 'model/ModelsAlertResponse', 'model/ModelsAllClusterCache', 'model/ModelsAttachment', 'model/ModelsAuthInfo', 'model/ModelsAutoWarmupContent', 'model/ModelsAutoWarmupContentRequest', 'model/ModelsAutoWarmupDailySchedule', 'model/ModelsAutoWarmupDomainSchedule', 'model/ModelsAutoWarmupPlan', 'model/ModelsAutoWarmupPlanRequest', 'model/ModelsAutoWarmupRecipient', 'model/ModelsAutoWarmupRecipientResponse', 'model/ModelsBackOffConfiguration', 'model/ModelsBackOffDecreaseType', 'model/ModelsBackOffTrigger', 'model/ModelsBillingPortalSession', 'model/ModelsBlackListEngine', 'model/ModelsBlackListResult', 'model/ModelsBlacklistResource', 'model/ModelsBlacklistStatus', 'model/ModelsBlacklistedOn', 'model/ModelsBulkResponse', 'model/ModelsCertificateDetails', 'model/ModelsCertificateExtensions', 'model/ModelsCertificateIssuer', 'model/ModelsCertificateSignature', 'model/ModelsCertificateSubject', 'model/ModelsCertificateValidity', 'model/ModelsCity', 'model/ModelsClusterCache', 'model/ModelsComment', 'model/ModelsConsumerStats', 'model/ModelsContent', 'model/ModelsCopyTo', 'model/ModelsCountStat', 'model/ModelsCountry', 'model/ModelsCoupon', 'model/ModelsCouponOptions', 'model/ModelsCreateMailReport', 'model/ModelsCustomerQuality', 'model/ModelsDNSRecord', 'model/ModelsDedicatedIPs', 'model/ModelsDeleteResponse', 'model/ModelsDetailedAlert', 'model/ModelsDomain', 'model/ModelsDomainAge', 'model/ModelsDomainCheckRequest', 'model/ModelsDomainCheckResult', 'model/ModelsDomainNameRecord', 'model/ModelsDomainRecord', 'model/ModelsEAccount', 'model/ModelsEAccountMember', 'model/ModelsEAccountSetting', 'model/ModelsEAccountTemplate', 'model/ModelsEAlert', 'model/ModelsEComment', 'model/ModelsEDomain', 'model/ModelsEIP', 'model/ModelsEIPPool', 'model/ModelsEIncident', 'model/ModelsEIntegration', 'model/ModelsEInvitation', 'model/ModelsEMember', 'model/ModelsESMTPAuth', 'model/ModelsESender', 'model/ModelsESubAccount', 'model/ModelsESystemDomain', 'model/ModelsETag', 'model/ModelsEThirdPartySendingProvider', 'model/ModelsEUpdateTPSP', 'model/ModelsEValidation', 'model/ModelsEWebhook', 'model/ModelsEditorTokenResponse', 'model/ModelsEmail', 'model/ModelsEmailErrorCode', 'model/ModelsEmailList', 'model/ModelsEmailMessage', 'model/ModelsEmailResponse', 'model/ModelsEntity', 'model/ModelsEventMetadata', 'model/ModelsEventType', 'model/ModelsFrequencyType', 'model/ModelsFrom', 'model/ModelsGlockappsMailReport', 'model/ModelsHetrixtoolsBlacklist', 'model/ModelsHetrixtoolsMonitorStat', 'model/ModelsHubspotEmail', 'model/ModelsHubspotEmailProperties', 'model/ModelsHubspotTicket', 'model/ModelsHubspotTicketProperties', 'model/ModelsIEIP', 'model/ModelsIEMember', 'model/ModelsIESubAccount', 'model/ModelsIETag', 'model/ModelsIIP', 'model/ModelsIIPUpdateType', 'model/ModelsIP', 'model/ModelsIPHealthResponse', 'model/ModelsIPPool', 'model/ModelsIPPoolType', 'model/ModelsIPProviderSettings', 'model/ModelsIPStat', 'model/ModelsIPState', 'model/ModelsIPType', 'model/ModelsIncident', 'model/ModelsIncidentStatus', 'model/ModelsInstance', 'model/ModelsIntegration', 'model/ModelsIntegrationSettings', 'model/ModelsIntegrationType', 'model/ModelsInvitation', 'model/ModelsInvitationStatus', 'model/ModelsJobStatus', 'model/ModelsLabel', 'model/ModelsLabelType', 'model/ModelsLinks', 'model/ModelsMailReportResult', 'model/ModelsMailgunClientInfo', 'model/ModelsMailgunDeliveryStatus', 'model/ModelsMailgunEvent', 'model/ModelsMailgunMessage', 'model/ModelsMailgunSignature', 'model/ModelsMailgunUserVariables', 'model/ModelsMember', 'model/ModelsMemberRole', 'model/ModelsNotificationType', 'model/ModelsOnboardingChecklist', 'model/ModelsPDStat', 'model/ModelsPaymentAddress', 'model/ModelsPaymentOptions', 'model/ModelsPaymentStatus', 'model/ModelsPostmasterDomainStat', 'model/ModelsPricing', 'model/ModelsProvider', 'model/ModelsProviderDetails', 'model/ModelsProviderResult', 'model/ModelsProviderSettings', 'model/ModelsQEmailMessage', 'model/ModelsQEvent', 'model/ModelsRAssumeAccount', 'model/ModelsRDStat', 'model/ModelsRDSuppression', 'model/ModelsRHetrixtoolsMonitorStat', 'model/ModelsRIPStat', 'model/ModelsRStat', 'model/ModelsRSuppression', 'model/ModelsReplyTo', 'model/ModelsReportProvider', 'model/ModelsRequestCreateTicket', 'model/ModelsResponse', 'model/ModelsSDStat', 'model/ModelsSMTPAuth', 'model/ModelsSMTPAuthCompleted', 'model/ModelsSMTPStat', 'model/ModelsSSLCertificate', 'model/ModelsSSLInfo', 'model/ModelsSender', 'model/ModelsSendgridEvent', 'model/ModelsStat', 'model/ModelsSubAccount', 'model/ModelsSubAccountType', 'model/ModelsSuppression', 'model/ModelsSuppressionEmail', 'model/ModelsSuppressionReason', 'model/ModelsSystemDNSRecord', 'model/ModelsSystemDomain', 'model/ModelsSystemEvent', 'model/ModelsSystemEventType', 'model/ModelsSystemIPPool', 'model/ModelsSystemTemplate', 'model/ModelsTag', 'model/ModelsTaxDetails', 'model/ModelsThirdPartySendingProvider', 'model/ModelsThirdPartySendingProviderType', 'model/ModelsTo', 'model/ModelsUMember', 'model/ModelsUploadFileResponse', 'model/ModelsValidation', 'model/ModelsValidationJob', 'model/ModelsValidationReason', 'model/ModelsValidationStat', 'model/ModelsValidationStatus', 'model/ModelsVerifyByMemberTokenRequest', 'model/ModelsVerifyByTokenRequest', 'model/ModelsWMessage', 'model/ModelsWarmupDetails', 'model/UaparserDevice', 'model/UaparserOs', 'model/UaparserUserAgent', 'api/AccountadminApi', 'api/AccountalertApi', 'api/AccountcustomerPortalApi', 'api/AccountdomainApi', 'api/AccountdomainReportApi', 'api/AccountdomainstatApi', 'api/AccounteventApi', 'api/AccountexportedApi', 'api/AccountincidentApi', 'api/AccountintegrationApi', 'api/AccountinvitationApi', 'api/AccountipApi', 'api/AccountippoolApi', 'api/AccountipstatApi', 'api/AccountlabelApi', 'api/AccountmailReportApi', 'api/AccountmemberApi', 'api/AccountmessageApi', 'api/AccountonboardingApi', 'api/AccountpaymentApi', 'api/AccountrecipientApi', 'api/AccountsettingApi', 'api/AccountsmtpstatApi', 'api/AccountstatApi', 'api/AccountsubaccountApi', 'api/AccountsubaccountstatApi', 'api/AccounttagApi', 'api/AccounttemplateApi', 'api/AccounttpspApi', 'api/AccounttpspstatApi', 'api/AccountvalidationApi', 'api/AccountwebhookApi', 'api/AuthApi', 'api/ClusterApi', 'api/EditorApi', 'api/SmtpApi', 'api/SubaccountdomainApi', 'api/SubaccountemailApi', 'api/SubaccountippoolApi', 'api/SubaccountsenderApi', 'api/SubaccountsuppressionApi', 'api/SystemsuppressionApi', 'api/SystemtemplateApi', 'api/TrackApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Model3668100x140007f5680False'), require('./model/Model3670910x140007f5770False'), require('./model/Model8726040x14000e02750False'), require('./model/ModelExport'), require('./model/ModelsAGDomainStat'), require('./model/ModelsAGIPStat'), require('./model/ModelsAGStat'), require('./model/ModelsAGSubAccountStat'), require('./model/ModelsAGTPSPStat'), require('./model/ModelsAIPStat'), require('./model/ModelsAPStat'), require('./model/ModelsASStat'), require('./model/ModelsAccount'), require('./model/ModelsAccountCycleUsage'), require('./model/ModelsAccountDomain'), require('./model/ModelsAccountIPPool'), require('./model/ModelsAccountTemplate'), require('./model/ModelsAccountUnlockTicket'), require('./model/ModelsAccountWebhook'), require('./model/ModelsAlert'), require('./model/ModelsAlertLabel'), require('./model/ModelsAlertRequest'), require('./model/ModelsAlertResponse'), require('./model/ModelsAllClusterCache'), require('./model/ModelsAttachment'), require('./model/ModelsAuthInfo'), require('./model/ModelsAutoWarmupContent'), require('./model/ModelsAutoWarmupContentRequest'), require('./model/ModelsAutoWarmupDailySchedule'), require('./model/ModelsAutoWarmupDomainSchedule'), require('./model/ModelsAutoWarmupPlan'), require('./model/ModelsAutoWarmupPlanRequest'), require('./model/ModelsAutoWarmupRecipient'), require('./model/ModelsAutoWarmupRecipientResponse'), require('./model/ModelsBackOffConfiguration'), require('./model/ModelsBackOffDecreaseType'), require('./model/ModelsBackOffTrigger'), require('./model/ModelsBillingPortalSession'), require('./model/ModelsBlackListEngine'), require('./model/ModelsBlackListResult'), require('./model/ModelsBlacklistResource'), require('./model/ModelsBlacklistStatus'), require('./model/ModelsBlacklistedOn'), require('./model/ModelsBulkResponse'), require('./model/ModelsCertificateDetails'), require('./model/ModelsCertificateExtensions'), require('./model/ModelsCertificateIssuer'), require('./model/ModelsCertificateSignature'), require('./model/ModelsCertificateSubject'), require('./model/ModelsCertificateValidity'), require('./model/ModelsCity'), require('./model/ModelsClusterCache'), require('./model/ModelsComment'), require('./model/ModelsConsumerStats'), require('./model/ModelsContent'), require('./model/ModelsCopyTo'), require('./model/ModelsCountStat'), require('./model/ModelsCountry'), require('./model/ModelsCoupon'), require('./model/ModelsCouponOptions'), require('./model/ModelsCreateMailReport'), require('./model/ModelsCustomerQuality'), require('./model/ModelsDNSRecord'), require('./model/ModelsDedicatedIPs'), require('./model/ModelsDeleteResponse'), require('./model/ModelsDetailedAlert'), require('./model/ModelsDomain'), require('./model/ModelsDomainAge'), require('./model/ModelsDomainCheckRequest'), require('./model/ModelsDomainCheckResult'), require('./model/ModelsDomainNameRecord'), require('./model/ModelsDomainRecord'), require('./model/ModelsEAccount'), require('./model/ModelsEAccountMember'), require('./model/ModelsEAccountSetting'), require('./model/ModelsEAccountTemplate'), require('./model/ModelsEAlert'), require('./model/ModelsEComment'), require('./model/ModelsEDomain'), require('./model/ModelsEIP'), require('./model/ModelsEIPPool'), require('./model/ModelsEIncident'), require('./model/ModelsEIntegration'), require('./model/ModelsEInvitation'), require('./model/ModelsEMember'), require('./model/ModelsESMTPAuth'), require('./model/ModelsESender'), require('./model/ModelsESubAccount'), require('./model/ModelsESystemDomain'), require('./model/ModelsETag'), require('./model/ModelsEThirdPartySendingProvider'), require('./model/ModelsEUpdateTPSP'), require('./model/ModelsEValidation'), require('./model/ModelsEWebhook'), require('./model/ModelsEditorTokenResponse'), require('./model/ModelsEmail'), require('./model/ModelsEmailErrorCode'), require('./model/ModelsEmailList'), require('./model/ModelsEmailMessage'), require('./model/ModelsEmailResponse'), require('./model/ModelsEntity'), require('./model/ModelsEventMetadata'), require('./model/ModelsEventType'), require('./model/ModelsFrequencyType'), require('./model/ModelsFrom'), require('./model/ModelsGlockappsMailReport'), require('./model/ModelsHetrixtoolsBlacklist'), require('./model/ModelsHetrixtoolsMonitorStat'), require('./model/ModelsHubspotEmail'), require('./model/ModelsHubspotEmailProperties'), require('./model/ModelsHubspotTicket'), require('./model/ModelsHubspotTicketProperties'), require('./model/ModelsIEIP'), require('./model/ModelsIEMember'), require('./model/ModelsIESubAccount'), require('./model/ModelsIETag'), require('./model/ModelsIIP'), require('./model/ModelsIIPUpdateType'), require('./model/ModelsIP'), require('./model/ModelsIPHealthResponse'), require('./model/ModelsIPPool'), require('./model/ModelsIPPoolType'), require('./model/ModelsIPProviderSettings'), require('./model/ModelsIPStat'), require('./model/ModelsIPState'), require('./model/ModelsIPType'), require('./model/ModelsIncident'), require('./model/ModelsIncidentStatus'), require('./model/ModelsInstance'), require('./model/ModelsIntegration'), require('./model/ModelsIntegrationSettings'), require('./model/ModelsIntegrationType'), require('./model/ModelsInvitation'), require('./model/ModelsInvitationStatus'), require('./model/ModelsJobStatus'), require('./model/ModelsLabel'), require('./model/ModelsLabelType'), require('./model/ModelsLinks'), require('./model/ModelsMailReportResult'), require('./model/ModelsMailgunClientInfo'), require('./model/ModelsMailgunDeliveryStatus'), require('./model/ModelsMailgunEvent'), require('./model/ModelsMailgunMessage'), require('./model/ModelsMailgunSignature'), require('./model/ModelsMailgunUserVariables'), require('./model/ModelsMember'), require('./model/ModelsMemberRole'), require('./model/ModelsNotificationType'), require('./model/ModelsOnboardingChecklist'), require('./model/ModelsPDStat'), require('./model/ModelsPaymentAddress'), require('./model/ModelsPaymentOptions'), require('./model/ModelsPaymentStatus'), require('./model/ModelsPostmasterDomainStat'), require('./model/ModelsPricing'), require('./model/ModelsProvider'), require('./model/ModelsProviderDetails'), require('./model/ModelsProviderResult'), require('./model/ModelsProviderSettings'), require('./model/ModelsQEmailMessage'), require('./model/ModelsQEvent'), require('./model/ModelsRAssumeAccount'), require('./model/ModelsRDStat'), require('./model/ModelsRDSuppression'), require('./model/ModelsRHetrixtoolsMonitorStat'), require('./model/ModelsRIPStat'), require('./model/ModelsRStat'), require('./model/ModelsRSuppression'), require('./model/ModelsReplyTo'), require('./model/ModelsReportProvider'), require('./model/ModelsRequestCreateTicket'), require('./model/ModelsResponse'), require('./model/ModelsSDStat'), require('./model/ModelsSMTPAuth'), require('./model/ModelsSMTPAuthCompleted'), require('./model/ModelsSMTPStat'), require('./model/ModelsSSLCertificate'), require('./model/ModelsSSLInfo'), require('./model/ModelsSender'), require('./model/ModelsSendgridEvent'), require('./model/ModelsStat'), require('./model/ModelsSubAccount'), require('./model/ModelsSubAccountType'), require('./model/ModelsSuppression'), require('./model/ModelsSuppressionEmail'), require('./model/ModelsSuppressionReason'), require('./model/ModelsSystemDNSRecord'), require('./model/ModelsSystemDomain'), require('./model/ModelsSystemEvent'), require('./model/ModelsSystemEventType'), require('./model/ModelsSystemIPPool'), require('./model/ModelsSystemTemplate'), require('./model/ModelsTag'), require('./model/ModelsTaxDetails'), require('./model/ModelsThirdPartySendingProvider'), require('./model/ModelsThirdPartySendingProviderType'), require('./model/ModelsTo'), require('./model/ModelsUMember'), require('./model/ModelsUploadFileResponse'), require('./model/ModelsValidation'), require('./model/ModelsValidationJob'), require('./model/ModelsValidationReason'), require('./model/ModelsValidationStat'), require('./model/ModelsValidationStatus'), require('./model/ModelsVerifyByMemberTokenRequest'), require('./model/ModelsVerifyByTokenRequest'), require('./model/ModelsWMessage'), require('./model/ModelsWarmupDetails'), require('./model/UaparserDevice'), require('./model/UaparserOs'), require('./model/UaparserUserAgent'), require('./api/AccountadminApi'), require('./api/AccountalertApi'), require('./api/AccountcustomerPortalApi'), require('./api/AccountdomainApi'), require('./api/AccountdomainReportApi'), require('./api/AccountdomainstatApi'), require('./api/AccounteventApi'), require('./api/AccountexportedApi'), require('./api/AccountincidentApi'), require('./api/AccountintegrationApi'), require('./api/AccountinvitationApi'), require('./api/AccountipApi'), require('./api/AccountippoolApi'), require('./api/AccountipstatApi'), require('./api/AccountlabelApi'), require('./api/AccountmailReportApi'), require('./api/AccountmemberApi'), require('./api/AccountmessageApi'), require('./api/AccountonboardingApi'), require('./api/AccountpaymentApi'), require('./api/AccountrecipientApi'), require('./api/AccountsettingApi'), require('./api/AccountsmtpstatApi'), require('./api/AccountstatApi'), require('./api/AccountsubaccountApi'), require('./api/AccountsubaccountstatApi'), require('./api/AccounttagApi'), require('./api/AccounttemplateApi'), require('./api/AccounttpspApi'), require('./api/AccounttpspstatApi'), require('./api/AccountvalidationApi'), require('./api/AccountwebhookApi'), require('./api/AuthApi'), require('./api/ClusterApi'), require('./api/EditorApi'), require('./api/SmtpApi'), require('./api/SubaccountdomainApi'), require('./api/SubaccountemailApi'), require('./api/SubaccountippoolApi'), require('./api/SubaccountsenderApi'), require('./api/SubaccountsuppressionApi'), require('./api/SystemsuppressionApi'), require('./api/SystemtemplateApi'), require('./api/TrackApi'));
  }
}(function(ApiClient, Model3668100x140007f5680False, Model3670910x140007f5770False, Model8726040x14000e02750False, ModelExport, ModelsAGDomainStat, ModelsAGIPStat, ModelsAGStat, ModelsAGSubAccountStat, ModelsAGTPSPStat, ModelsAIPStat, ModelsAPStat, ModelsASStat, ModelsAccount, ModelsAccountCycleUsage, ModelsAccountDomain, ModelsAccountIPPool, ModelsAccountTemplate, ModelsAccountUnlockTicket, ModelsAccountWebhook, ModelsAlert, ModelsAlertLabel, ModelsAlertRequest, ModelsAlertResponse, ModelsAllClusterCache, ModelsAttachment, ModelsAuthInfo, ModelsAutoWarmupContent, ModelsAutoWarmupContentRequest, ModelsAutoWarmupDailySchedule, ModelsAutoWarmupDomainSchedule, ModelsAutoWarmupPlan, ModelsAutoWarmupPlanRequest, ModelsAutoWarmupRecipient, ModelsAutoWarmupRecipientResponse, ModelsBackOffConfiguration, ModelsBackOffDecreaseType, ModelsBackOffTrigger, ModelsBillingPortalSession, ModelsBlackListEngine, ModelsBlackListResult, ModelsBlacklistResource, ModelsBlacklistStatus, ModelsBlacklistedOn, ModelsBulkResponse, ModelsCertificateDetails, ModelsCertificateExtensions, ModelsCertificateIssuer, ModelsCertificateSignature, ModelsCertificateSubject, ModelsCertificateValidity, ModelsCity, ModelsClusterCache, ModelsComment, ModelsConsumerStats, ModelsContent, ModelsCopyTo, ModelsCountStat, ModelsCountry, ModelsCoupon, ModelsCouponOptions, ModelsCreateMailReport, ModelsCustomerQuality, ModelsDNSRecord, ModelsDedicatedIPs, ModelsDeleteResponse, ModelsDetailedAlert, ModelsDomain, ModelsDomainAge, ModelsDomainCheckRequest, ModelsDomainCheckResult, ModelsDomainNameRecord, ModelsDomainRecord, ModelsEAccount, ModelsEAccountMember, ModelsEAccountSetting, ModelsEAccountTemplate, ModelsEAlert, ModelsEComment, ModelsEDomain, ModelsEIP, ModelsEIPPool, ModelsEIncident, ModelsEIntegration, ModelsEInvitation, ModelsEMember, ModelsESMTPAuth, ModelsESender, ModelsESubAccount, ModelsESystemDomain, ModelsETag, ModelsEThirdPartySendingProvider, ModelsEUpdateTPSP, ModelsEValidation, ModelsEWebhook, ModelsEditorTokenResponse, ModelsEmail, ModelsEmailErrorCode, ModelsEmailList, ModelsEmailMessage, ModelsEmailResponse, ModelsEntity, ModelsEventMetadata, ModelsEventType, ModelsFrequencyType, ModelsFrom, ModelsGlockappsMailReport, ModelsHetrixtoolsBlacklist, ModelsHetrixtoolsMonitorStat, ModelsHubspotEmail, ModelsHubspotEmailProperties, ModelsHubspotTicket, ModelsHubspotTicketProperties, ModelsIEIP, ModelsIEMember, ModelsIESubAccount, ModelsIETag, ModelsIIP, ModelsIIPUpdateType, ModelsIP, ModelsIPHealthResponse, ModelsIPPool, ModelsIPPoolType, ModelsIPProviderSettings, ModelsIPStat, ModelsIPState, ModelsIPType, ModelsIncident, ModelsIncidentStatus, ModelsInstance, ModelsIntegration, ModelsIntegrationSettings, ModelsIntegrationType, ModelsInvitation, ModelsInvitationStatus, ModelsJobStatus, ModelsLabel, ModelsLabelType, ModelsLinks, ModelsMailReportResult, ModelsMailgunClientInfo, ModelsMailgunDeliveryStatus, ModelsMailgunEvent, ModelsMailgunMessage, ModelsMailgunSignature, ModelsMailgunUserVariables, ModelsMember, ModelsMemberRole, ModelsNotificationType, ModelsOnboardingChecklist, ModelsPDStat, ModelsPaymentAddress, ModelsPaymentOptions, ModelsPaymentStatus, ModelsPostmasterDomainStat, ModelsPricing, ModelsProvider, ModelsProviderDetails, ModelsProviderResult, ModelsProviderSettings, ModelsQEmailMessage, ModelsQEvent, ModelsRAssumeAccount, ModelsRDStat, ModelsRDSuppression, ModelsRHetrixtoolsMonitorStat, ModelsRIPStat, ModelsRStat, ModelsRSuppression, ModelsReplyTo, ModelsReportProvider, ModelsRequestCreateTicket, ModelsResponse, ModelsSDStat, ModelsSMTPAuth, ModelsSMTPAuthCompleted, ModelsSMTPStat, ModelsSSLCertificate, ModelsSSLInfo, ModelsSender, ModelsSendgridEvent, ModelsStat, ModelsSubAccount, ModelsSubAccountType, ModelsSuppression, ModelsSuppressionEmail, ModelsSuppressionReason, ModelsSystemDNSRecord, ModelsSystemDomain, ModelsSystemEvent, ModelsSystemEventType, ModelsSystemIPPool, ModelsSystemTemplate, ModelsTag, ModelsTaxDetails, ModelsThirdPartySendingProvider, ModelsThirdPartySendingProviderType, ModelsTo, ModelsUMember, ModelsUploadFileResponse, ModelsValidation, ModelsValidationJob, ModelsValidationReason, ModelsValidationStat, ModelsValidationStatus, ModelsVerifyByMemberTokenRequest, ModelsVerifyByTokenRequest, ModelsWMessage, ModelsWarmupDetails, UaparserDevice, UaparserOs, UaparserUserAgent, AccountadminApi, AccountalertApi, AccountcustomerPortalApi, AccountdomainApi, AccountdomainReportApi, AccountdomainstatApi, AccounteventApi, AccountexportedApi, AccountincidentApi, AccountintegrationApi, AccountinvitationApi, AccountipApi, AccountippoolApi, AccountipstatApi, AccountlabelApi, AccountmailReportApi, AccountmemberApi, AccountmessageApi, AccountonboardingApi, AccountpaymentApi, AccountrecipientApi, AccountsettingApi, AccountsmtpstatApi, AccountstatApi, AccountsubaccountApi, AccountsubaccountstatApi, AccounttagApi, AccounttemplateApi, AccounttpspApi, AccounttpspstatApi, AccountvalidationApi, AccountwebhookApi, AuthApi, ClusterApi, EditorApi, SmtpApi, SubaccountdomainApi, SubaccountemailApi, SubaccountippoolApi, SubaccountsenderApi, SubaccountsuppressionApi, SystemsuppressionApi, SystemtemplateApi, TrackApi) {
  'use strict';
  ...
  var exports = {
    ...
    ApiClient: ApiClient,
    /**
     * The Model3668100x140007f5680False model constructor.
     * @property {module:model/Model3668100x140007f5680False}
     */
    Model3668100x140007f5680False: Model3668100x140007f5680False,
    /**
     * The Model3670910x140007f5770False model constructor.
     * @property {module:model/Model3670910x140007f5770False}
     */
    Model3670910x140007f5770False: Model3670910x140007f5770False,
    /**
     * The Model8726040x14000e02750False model constructor.
     * @property {module:model/Model8726040x14000e02750False}
     */
    Model8726040x14000e02750False: Model8726040x14000e02750False,
    /**
    ...
    /**
     * The ModelsDomainCheckRequest model constructor.
     * @property {module:model/ModelsDomainCheckRequest}
     */
    ModelsDomainCheckRequest: ModelsDomainCheckRequest,
    /**
    ...
    /**
     * The ModelsDomainNameRecord model constructor.
     * @property {module:model/ModelsDomainNameRecord}
     */
    ModelsDomainNameRecord: ModelsDomainNameRecord,
    /**
     * The ModelsDomainRecord model constructor.
     * @property {module:model/ModelsDomainRecord}
     */
    ModelsDomainRecord: ModelsDomainRecord,
    /**
    ...
    /**
     * The ModelsESMTPAuth model constructor.
     * @property {module:model/ModelsESMTPAuth}
     */
    ModelsESMTPAuth: ModelsESMTPAuth,
    /**
    ...
    /**
     * The ModelsEmail model constructor.
     * @property {module:model/ModelsEmail}
     */
    ...
    /**
     * The ModelsEntity model constructor.
     * @property {module:model/ModelsEntity}
     */
    ...
    /**
     * The ModelsHubspotEmail model constructor.
     * @property {module:model/ModelsHubspotEmail}
     */
    ModelsHubspotEmail: ModelsHubspotEmail,
    /**
     * The ModelsHubspotEmailProperties model constructor.
     * @property {module:model/ModelsHubspotEmailProperties}
     */
    ModelsHubspotEmailProperties: ModelsHubspotEmailProperties,
    /**
     * The ModelsHubspotTicket model constructor.
     * @property {module:model/ModelsHubspotTicket}
     */
    ModelsHubspotTicket: ModelsHubspotTicket,
    /**
     * The ModelsHubspotTicketProperties model constructor.
     * @property {module:model/ModelsHubspotTicketProperties}
     */
    ModelsHubspotTicketProperties: ModelsHubspotTicketProperties,
    /**
    ...
    /**
     * The ModelsIPState model constructor.
     * @property {module:model/ModelsIPState}
     */
    ModelsIPState: ModelsIPState,
    /**
    ...
    /**
     * The ModelsRequestCreateTicket model constructor.
     * @property {module:model/ModelsRequestCreateTicket}
     */
    ModelsRequestCreateTicket: ModelsRequestCreateTicket,
    /**
    ...
    /**
     * The ModelsSMTPAuthCompleted model constructor.
     * @property {module:model/ModelsSMTPAuthCompleted}
     */
    ModelsSMTPAuthCompleted: ModelsSMTPAuthCompleted,
    /**
    ...
    /**
     * The ModelsSystemEvent model constructor.
     * @property {module:model/ModelsSystemEvent}
     */
    ModelsSystemEvent: ModelsSystemEvent,
    /**
     * The ModelsSystemEventType model constructor.
     * @property {module:model/ModelsSystemEventType}
     */
    ModelsSystemEventType: ModelsSystemEventType,
    /**
    ...
    /**
     * The ModelsUploadFileResponse model constructor.
     * @property {module:model/ModelsUploadFileResponse}
     */
    ModelsUploadFileResponse: ModelsUploadFileResponse,
    /**
    ...
    /**
     * The ModelsValidationStat model constructor.
     * @property {module:model/ModelsValidationStat}
     */
    ModelsValidationStat: ModelsValidationStat,
    /**
     * The ModelsValidationStatus model constructor.
     * @property {module:model/ModelsValidationStatus}
     */
    ModelsValidationStatus: ModelsValidationStatus,
    /**
    ...
    /**
     * The ModelsWarmupDetails model constructor.
     * @property {module:model/ModelsWarmupDetails}
     */
    ModelsWarmupDetails: ModelsWarmupDetails,
    /**
    ...
    /**
     * The AccountcustomerPortalApi service constructor.
     * @property {module:api/AccountcustomerPortalApi}
     */
    AccountcustomerPortalApi: AccountcustomerPortalApi,
    /**
    ...
    /**
     * The AccountexportedApi service constructor.
     * @property {module:api/AccountexportedApi}
     */
    AccountexportedApi: AccountexportedApi,
    /**
