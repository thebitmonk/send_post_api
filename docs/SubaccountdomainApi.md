...
# **domainRouterCreate**
> domainRouterCreate(xSubAccountApiKey, body)
...
# **domainRouterDelete**
> domainRouterDelete(xSubAccountApiKey, domainId)
...
# **domainRouterGetAll**
> [ModelsDomain] domainRouterGetAll(xSubAccountApiKey)
...
apiInstance.domainRouterGetAll(xSubAccountApiKey, callback);
```
