...
*/
func (a *TrackApiService) TrackRouterTrackEmailOpen(ctx context.Context, ipId int64, subAccountId int64, messageId string, emailType string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/track/open/{subAccountId}/{ipId}/{emailType}/{messageId}/1.png"
...
*/
func (a *TrackApiService) TrackRouterTrackLinkClick(ctx context.Context, ipId int64, subAccountId int64, messageId string, emailType string, redirecturl string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/track/click/{subAccountId}/{ipId}/{emailType}/{messageId}"
	localVarPath = strings.Replace(localVarPath, "{"+"ipId"+"}", fmt.Sprintf("%v", ipId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"subAccountId"+"}", fmt.Sprintf("%v", subAccountId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"messageId"+"}", fmt.Sprintf("%v", messageId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"emailType"+"}", fmt.Sprintf("%v", emailType), -1)
...
*/
func (a *TrackApiService) TrackRouterTrackUnsubscribe(ctx context.Context, subAccountId int64, messageId int64) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/track/unsubscribe/{subAccountId}/{messageId}"
	localVarPath = strings.Replace(localVarPath, "{"+"subAccountId"+"}", fmt.Sprintf("%v", subAccountId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"messageId"+"}", fmt.Sprintf("%v", messageId), -1)
